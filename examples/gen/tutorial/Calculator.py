...
import gen.shared.SharedService
from ttypes import *
...
class Client(gen.shared.SharedService.Client, Iface):
  """
  Ahh, now onto the cool part, defining a service. Services just need a name
  and can optionally inherit from another service using the extends keyword.
  """
  def __init__(self, iprot, oprot=None):
    gen.shared.SharedService.Client.__init__(self, iprot, oprot)
...
class Processor(gen.shared.SharedService.Processor, Iface, TProcessor):
  def __init__(self, handler):
    gen.shared.SharedService.Processor.__init__(self, handler)
